...
namespace Triptitude.Biz.Models
{
    public class Db : DbContext
    {
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Activity>().HasOptional(a => a.LodgingActivity).WithRequired();
            //modelBuilder.Entity<Activity>().HasOptional(a => a.TransportationActivity).WithRequired();
            //modelBuilder.Entity<Activity>().HasOptional(a => a.WebsiteActivity).WithRequired();

            //modelBuilder.Entity<Activity>().ToTable("Activities");
            //modelBuilder.Entity<TransportationActivity>().ToTable("TransportationActivities");
        ...
        public DbSet<WebsiteActivity> WebsiteActivity { get; set; }
